...
var timer; var timeRemaining; var lives; var selectedNum; var selectedTile; var disableSelect;
...
function generateBoard(board) {
    ...
    for (let i = 0; i < 81; i++) {
        ...
        if (board.charAt(i) != "-") {
            ...
            //ovo na krjau dodajemo lisener na tile click
...
function updateMove() {
    ...
    if (selectedTile && selectedNum) {
        ...
        if (checkCorrect(selectedTile)) {
            ...
            //brisemo izabrani novi za jednu sek
